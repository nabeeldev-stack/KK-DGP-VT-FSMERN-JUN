    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #1a0000, #0a0a0b, #120000)", padding: "20px" }}>
            <div style={{ maxWidth: "420px", width: "100%", padding: "40px", borderRadius: "20px", border: "1px solid rgba(239,68,68,0.2)", background: "rgba(255,255,255,0.03)", backdropFilter: "blur(16px)" }}>
                ...
                <p style={{ textAlign: "center", color: "#9ca3af", marginBottom: "8px" }}>Enter the verification code sent to your email.</p>
                <form onSubmit={verifyHandler} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    ...
                    <button type="button" onClick={resendOtp} disabled={loading || !email}
                        style={{ padding: "12px", borderRadius: "12px", border: "1px solid rgba(239,68,68,0.2)", background: "transparent", color: "#ef4444", fontSize: "0.9rem", fontWeight: "600", cursor: loading || !email ? "not-allowed" : "pointer", opacity: loading || !email ? 0.6 : 1 }}>
                        Resend OTP
                    </button>
